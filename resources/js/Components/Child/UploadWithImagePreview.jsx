...
const UploadWithImagePreview = (props) => {
        ...
        <div className="col-md-12">
            <div className="card h-100 p-0">
                <div className="card-header border-bottom bg-base py-16 px-24">
                    <h6 className="text-lg fw-semibold mb-0">Téléverser {props.img !=null ? props.img : "une image"}</h6>
                </div>
                <div className="card-body p-24">
                    <div
                        className={`upload-image-wrapper d-flex align-items-center gap-3 flex-wrap ${isDragging ? 'dragging' : ''}`}
