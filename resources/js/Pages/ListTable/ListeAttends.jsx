...
import { getListeAttends, deleteRendezVous } from '../../Redux/rendezvous/rendezvousSlice';
...
const ListeAttends = () => {
    ...
    const { listeAttends: rendezVous, status, error } = useSelector((state) => state.rendezvous);
    ...
    const loadRendezVous = useCallback(async () => {
        try {
            setIsLoading(true);
            const result = await dispatch(getListeAttends()).unwrap();
            console.log('Rendez-vous en attente chargés:', result);
        } catch (error) {
        ...
        <div className="container mx-auto px-4 py-8">
            <div className="bg-white rounded-lg shadow-lg p-6">
                <div className="flex justify-between items-center mb-6">
                    <h1 className="text-2xl font-bold text-gray-800">Liste D'attente</h1>
