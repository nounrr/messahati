...
const ChatProfileLayer = ({ isMinimized = false }) => {
    // Styles conditionnels basés sur isMinimized
    const containerClass = isMinimized 
        ? "chat-wrapper p-2" 
        : "chat-wrapper";
    
    const sidebarClass = isMinimized
        ? "chat-sidebar profile-setting card p-3"
        : "chat-sidebar profile-setting card";
    
    const imageClass = isMinimized
        ? "w-12 h-12 rounded-full mx-auto"
        : "w-auto";
    
    const headerClass = isMinimized
        ? "text-sm font-medium"
        : "text-lg";
        
    const marginClass = isMinimized
        ? "mt-3"
        : "mt-24";
            ...
            <div className={sidebarClass}>
                ...
                <div className="chat-main-profile">
                    <div className="img text-center">
                        <img 
                            src="/assets/images/chat/chat-main.png" 
                            alt="Profile" 
                            className={imageClass} 
                        />
                    </div>
                    <div className="text-center">
                        <h6 className={`${headerClass} mb-0`}>Kathryn Murphy</h6>
                ...
                <div className={marginClass}>
                    <h6 className={headerClass}>Status</h6>
