...
import { createTypeMedicament } from '../../../Redux/typeMedicaments/typeMedicamentSlice';
    ...
    return (
        <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className='text-center mb-6'>
                ...
                <h4 className='text-2xl font-semibold mb-1'>Ajoutez les différents Types de Médicaments</h4>
