...
class ChatController extends Controller
{
    ...
    public function __call($method, $parameters)
    {
        if (method_exists($this, $method)) {
            return $this->middleware('auth:sanctum')->$method(...$parameters);
        }
    ...
    public function send(Request $request)
    {
        try {
            ...
            $pusherResult = $this->pusherService->sendToUser(
            ...
            // Si Pusher échoue, on continue quand même
            if (!$pusherResult) {
                Log::warning('Échec de l\'envoi de la notification Pusher, mais le message a été enregistré');
            }
